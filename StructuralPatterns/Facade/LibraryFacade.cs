...
namespace StructuralPatterns.Facade
{
    ...
    class CatalogSystem 
    { 
        public string CheckAvailability(string book) => $"Каталог: Книга '{book}' в наличии."; 
    }
    class BorrowingSystem 
    { 
        public string ProcessCheckout(string user, string book) => $"Оформление: Книга '{book}' выдана пользователю {user}."; 
    }
}